...
%%
%%folder 1
folder1='D:\Evolver_calc\Hemifission\Diaphragm\l=1.0nm\R=free x=4 y=15';
cd(folder1);
...
%%
%%folder 2
folder2='D:\Evolver_calc\Hemifission\Diaphragm\l=1.5nm\R=free x=4 y=15';
cd(folder2);
